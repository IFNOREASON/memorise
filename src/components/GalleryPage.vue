      ...
      <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-6">
        ...
        <div class="space-y-5">
          ...
          <div v-if="previewMedias.length > 0">
            <label class="block text-sm font-medium text-gray-700 mb-2">已选择</label>
        ...
        <div class="space-y-5">
          ...
          <div>
            ...
            <div class="border-2 border-dashed border-[#E8D5C4] rounded-xl p-8 text-center hover:border-[#D4A574] transition-colors cursor-pointer">
              ...
              <p class="text-xs text-gray-400 mt-1">支持 JPG、PNG 格式，建议最少 5 张</p>
            </div>
          </div>
        </div>
...
const previewMedias = ref<{ url: string; type: 'image' | 'video' }[]>([])
